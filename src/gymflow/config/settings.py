...
class Settings(BaseSettings):
    """Config central — GymFlow v1 (sem legado GMS)."""

    model_config = SettingsConfigDict(
        env_prefix="GYMFLOW_", env_file=".env", env_file_encoding="utf-8", extra="ignore"
    )
    ...
    db_url: str = Field(default="sqlite:///data/gymflow.db")
    log_level: str = Field(default="INFO")

    app_name: str = Field(default="GymFlow")
