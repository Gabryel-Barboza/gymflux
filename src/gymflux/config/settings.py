...
class Settings(BaseSettings):
    """Config central — GymFlux v1 (sem legado GMS)."""

    model_config = SettingsConfigDict(
        env_prefix="GYMFLUX_", env_file=".env", env_file_encoding="utf-8", extra="ignore"
    )
    ...
    db_url: str = Field(default="sqlite:///data/gymflux.db")
    log_level: str = Field(default="INFO")

    app_name: str = Field(default="GymFlux")
