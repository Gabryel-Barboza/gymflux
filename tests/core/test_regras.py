"""Testes RegraAcesso — RB01 tolerância, RB02 vigência, RB03 bloqueio, RB04 timeout, RB05."""
...
# helpers de data fixa para testes determinísticos
HOJE = date(2026, 9, 11)
...
# -- RB05 anti-passback opcional + pode_acessar compat -------------------
