...
- **2026-09-15 — Fase 4.16 perf Caixa + turnos ✅:**
  ...
  - Verificação Linux: 196 passed +1 skipped, ruff ok (RUF001-003 ignorado p/ en-dash), mypy 87 files ok, `data/gymflux.db` 7,6k/10k medido; commits `3917be5 perf(caixa)` + `b338cb0 feat(funcionarios)`.
...
- [x] Fase 4.16 (dono 2026-09-15) ✅: caixa fluido em 7k+ (medido ~2s→136ms cold/21ms warm) → pushdown SQL + refresh único; horários de funcionário em turnos (manhã/tarde) com boa legibilidade (ver §4).
...
---
*Última atualização: 2026-09-15 por subordinado (Fase 4.16 perf Caixa + turnos, 196 passed). Mantenha este arquivo enxuto e factual.*
